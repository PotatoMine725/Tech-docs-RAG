...
| 03 | `03-INGEST-001-models-parser-normalization.md` | INGEST-001 | 00 + 00R verified (parallel with 01/02) | verified | `1858e27`; `98fdb5a` ("INGEST-001: fixes from verification") | [INGEST-001](../reports/execution/INGEST-001.md) | [INGEST-001-verify](../reviews/code/INGEST-001-verify.md) → ACCEPT WITH FIXES (`50f45b1`); [INGEST-001-reverify](../reviews/code/INGEST-001-reverify.md) → ACCEPT | Fixes 1–5 of the first verify re-verified 2026-09-25 → ACCEPT (`normalized.jsonl` unchanged, 63 tests pass). The INGEST-001 prerequisite of 04/05 is met. Open, non-blocking: (1) **owner decision pending:** confirm the page-footer removal (`- Last updated on` + date + `---`, 19 docs), an extension of ADR-0003 D1 (spec § Normalization, report Deviation 6); (2) owner decision (optional): remove the known residue (`---` before "Additional resources", #15 Q&A text), which would change `normalized.jsonl` and needs a test; (3) "#12/#13" → "#12" for tab-selector lists in the normalizer comment and spec; (4) byline regex could hit prose in a future corpus (INGEST-003). Not evidenced: pre-edit impact runs, chat "Explain it back". |
