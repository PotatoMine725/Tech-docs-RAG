...
| 03 | `03-INGEST-001-models-parser-normalization.md` | INGEST-001 | 00 + 00R verified (parallel with 01/02) | done | "INGEST-001: core models, Markdown parser, normalization" | [INGEST-001](../reports/execution/INGEST-001.md) | not yet | 00 is `verified`; starts after REORIENT-001 is `verified` (the ledger guard in `_common.md` must itself be verified first). |
