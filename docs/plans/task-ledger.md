...
| 02 | `02-EVAL-002-write-and-freeze.md` | EVAL-002 | 01 + owner review | not started | — | — | — | **Blocked** until both: EVAL-001 `verified` (re-verify) **and** every `owner verdict:` in the owner re-check filled. |
| 03 | `03-INGEST-001-models-parser-normalization.md` | INGEST-001 | 00 (parallel with 01/02) | not started | — | — | — | Prerequisite 00 is `verified`: may start. |
