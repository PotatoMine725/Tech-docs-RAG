...
Status: in progress. RAG-001a done 2026-09-26 (embedder + cache, V-1, ADR-0005; verified). RAG-001b done 2026-09-26 (Chroma store, both arms indexed: A 733 = 733, B 859 = 859; awaiting 99-VERIFY); G3 box 1 ticked. OD-7 and OD-8 decided (ADR-0005). The index is in `data/chroma/` (OD-7), rebuilt from the embedding cache with 0 API requests.
