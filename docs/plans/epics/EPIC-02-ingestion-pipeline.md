...
Status: in progress. INGEST-001 (models, parser, normalization) verified 2026-09-25 (re-verify ACCEPT); INGEST-002 (both chunkers + stats) done 2026-09-25, awaiting `99-VERIFY`; INGEST-003 not started (ready, cuttable). Task status: [ledger](../task-ledger.md).
