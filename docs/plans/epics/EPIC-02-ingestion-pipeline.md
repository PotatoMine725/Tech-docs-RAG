...
Status: in progress. INGEST-001 (models, parser, normalization) verified 2026-09-25 (re-verify ACCEPT); INGEST-002/003 not started (ready). Task status: [ledger](../task-ledger.md).
