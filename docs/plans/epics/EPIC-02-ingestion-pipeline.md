...
Status: in progress. INGEST-001 (models, parser, normalization) verified 2026-09-25 (re-verify ACCEPT); INGEST-002 (both chunkers + stats) verified 2026-09-25 (ACCEPT, G2 passed); INGEST-003 (MarkItDown adapter) done 2026-09-25, awaiting `99-VERIFY`. Task status: [ledger](../task-ledger.md).
