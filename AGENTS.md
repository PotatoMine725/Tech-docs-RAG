...
This project is indexed by GitNexus as **Tech-docs-RAG** (3348 symbols, 4626 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
