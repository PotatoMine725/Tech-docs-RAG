...
This project is indexed by GitNexus as **Tech-docs-RAG** (1498 symbols, 1630 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
